...
RockSmashSprite::        INCBIN "gfx/sprites/rock.2bpp"
...
OfficeLadySprite::       INCBIN "gfx/sprites/office_lady.2bpp"
...
TeacherSprite::          INCBIN "gfx/sprites/teacher.2bpp"
GuitaristSprite::        INCBIN "gfx/sprites/guitarist.2bpp"
SwimmerGirlSprite::      INCBIN "gfx/sprites/swimmer_girl.2bpp"
BigSnorlaxSprite::       INCBIN "gfx/sprites/big_snorlax.2bpp"
RocketGirlSprite::       INCBIN "gfx/sprites/rocket_girl.2bpp"
KimonoGirlSprite::       INCBIN "gfx/sprites/kimono_girl.2bpp"
SageSprite::     	     INCBIN "gfx/sprites/sage.2bpp"
ReceptionistSprite::     INCBIN "gfx/sprites/receptionist.2bpp"
CelioSprite::            INCBIN "gfx/sprites/celio.2bpp"
SlowpokeSprite::         INCBIN "gfx/sprites/slowpoke.2bpp"
BigLaprasSprite::        INCBIN "gfx/sprites/big_lapras.2bpp"
BigOnixSprite::          INCBIN "gfx/sprites/big_onix.2bpp"
N64Sprite::              INCBIN "gfx/sprites/n64.2bpp"
VirtualBoySprite::       INCBIN "gfx/sprites/virtual_boy.2bpp"
SnesSprite::             INCBIN "gfx/sprites/snes.2bpp"
FamicomSprite::          INCBIN "gfx/sprites/famicom.2bpp"
GoldTrophySprite::       INCBIN "gfx/sprites/gold_trophy.2bpp"
SilverTrophySprite::     INCBIN "gfx/sprites/silver_trophy.2bpp"
