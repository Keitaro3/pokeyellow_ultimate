...
DEF rNR13                EQU $ff13 ; Channel 1 Fr   EQUency lo (Write Only)
DEF rNR14                EQU $ff14 ; Channel 1 Fr   EQUency hi (R/W)
DEF rNR21                EQU $ff16 ; Channel 2 Sound Length/Wave Pattern Duty (R/W)
DEF rNR22                EQU $ff17 ; Channel 2 Volume Envelope (R/W)
DEF rNR23                EQU $ff18 ; Channel 2 Fr   EQUency lo data (W)
DEF rNR24                EQU $ff19 ; Channel 2 Fr   EQUency hi data (R/W)
...
DEF rNR33                EQU $ff1d ; Channel 3 Fr   EQUency's lower data (W)
DEF rNR34                EQU $ff1e ; Channel 3 Fr   EQUency's higher data (R/W)
