...
ClefairyEvosMoves:
; Evolutions
	db EV_ITEM, MOON_STONE, CLEFABLE
	db 0
; Learnset
	db 13, SING
	db 18, DOUBLESLAP
...
ExeggcuteEvosMoves:
; Evolutions
	db EV_ITEM, LEAF_STONE, EXEGGUTOR
	db 0
; Learnset
	db 25, REFLECT
	db 28, LEECH_SEED
...
ShellderEvosMoves:
; Evolutions
	db EV_ITEM, WATER_STONE, CLOYSTER
	db 0
; Learnset
	db 18, SUPERSONIC
	db 23, CLAMP
...
ScytherEvosMoves:
; Evolutions
	db EV_TRADE, METAL_COAT_GSC, SCIZOR
	db 0
; Learnset
	db 17, LEER
	db 20, FOCUS_ENERGY
...
StaryuEvosMoves:
; Evolutions
	db EV_ITEM, WATER_STONE, STARMIE
	db 0
; Learnset
	db 17, WATER_GUN
	db 22, HARDEN
...
GrowlitheEvosMoves:
; Evolutions
	db EV_ITEM, FIRE_STONE, ARCANINE
	db 0
; Learnset
	db 18, EMBER
	db 23, LEER
...
OnixEvosMoves:
; Evolutions
	db EV_TRADE, METAL_COAT_GSC, STEELIX
	db 0
; Learnset
	db 15, BIND
	db 19, ROCK_THROW
...
; Evolutions
	...
	db EV_TRADE, KINGS_ROCK_GSC, SLOWKING
	db 0
; Learnset
	db 18, DISABLE
	db 22, HEADBUTT
...
VulpixEvosMoves:
; Evolutions
	db EV_ITEM, FIRE_STONE, NINETALES
	db 0
; Learnset
	db 16, QUICK_ATTACK
	db 21, ROAR
...
PikachuEvosMoves:
; Evolutions
	db EV_ITEM, THUNDER_STONE, RAICHU
	db 0
; Learnset
	db 6, TAIL_WHIP
	db 8, THUNDER_WAVE
...
SeadraEvosMoves:
; Evolutions
	db EV_TRADE, DRAGON_SCALE_GSC, KINGDRA
	db 0
; Learnset
	db 19, SMOKESCREEN
	db 24, LEER
...
JigglypuffEvosMoves:
; Evolutions
	db EV_ITEM, MOON_STONE, WIGGLYTUFF
	db 0
; Learnset
	db 9, POUND
	db 14, DISABLE
...
EeveeEvosMoves:
; Evolutions
	db EV_ITEM, FIRE_STONE, FLAREON
	db EV_ITEM, THUNDER_STONE, JOLTEON
	db EV_ITEM, WATER_STONE, VAPOREON
	db EV_HAPPINESS, TR_MORNDAY, ESPEON
	db EV_HAPPINESS, TR_NITE, UMBREON
	db 0
; Learnset
	db 8, SAND_ATTACK
	db 16, GROWL
...
PoliwhirlEvosMoves:
; Evolutions
	db EV_ITEM, WATER_STONE, POLIWRATH
	db EV_TRADE, KINGS_ROCK_GSC, POLITOED
	db 0
; Learnset
	db 16, HYPNOSIS
	db 19, WATER_GUN
...
TyrogueEvosMoves:
;Evolutions
	db EV_STAT, 20, ATK_LT_DEF, HITMONCHAN
	db EV_STAT, 20, ATK_GT_DEF, HITMONLEE
	db EV_STAT, 20, ATK_EQ_DEF, HITMONTOP
	db 0
;Learnset
	db 0
...
NidorinoEvosMoves:
; Evolutions
	db EV_ITEM, MOON_STONE, NIDOKING
	db 0
; Learnset
	db 8, HORN_ATTACK
	db 12, DOUBLE_KICK
...
NidorinaEvosMoves:
; Evolutions
	db EV_ITEM, MOON_STONE, NIDOQUEEN
	db 0
; Learnset
	db 8, SCRATCH
	db 12, DOUBLE_KICK
...
PorygonEvosMoves:
; Evolutions
	db EV_TRADE, UP_GRADE_GSC, PORYGON2
	db 0
; Learnset
	db 23, PSYBEAM
	db 28, RECOVER
...
GloomEvosMoves:
; Evolutions
	db EV_ITEM, LEAF_STONE, VILEPLUME
	db EV_ITEM, SUN_STONE, BELLOSSOM
	db 0
; Learnset
	db 15, POISONPOWDER
	db 17, STUN_SPORE
...
WeepinbellEvosMoves:
; Evolutions
	db EV_ITEM, LEAF_STONE, VICTREEBEL
	db 0
; Learnset
	db 13, WRAP
	db 15, POISONPOWDER
