...
MapSpriteSets:
	...
	db SPRITESET_CELADON         ; ROUTE_16
	db SPRITESET_CELADON         ; ROUTE_17
...
SplitMapSpriteSets:
	...
	db EAST_WEST,   34, SPRITESET_CELADON,         SPRITESET_FUCHSIA         ; SPLITSET_ROUTE_18
	db EAST_WEST,   17, SPRITESET_PEWTER,          SPRITESET_CERULEAN		 ; SPLITSET_ROUTE_4
