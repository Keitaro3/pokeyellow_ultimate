SafariZoneGate_Object:
	...
	def_object_events
	object_event  6,  2, SPRITE_SAFARI_ZONE_WORKER, STAY, LEFT, PAL_NPC_GREEN, 1 ; person
	object_event  1,  4, SPRITE_SAFARI_ZONE_WORKER, STAY, RIGHT, PAL_NPC_GREEN, 2 ; person
