PokemonTower4F_Object:
	...
	def_object_events
	object_event  5, 10, SPRITE_CHANNELER, STAY, RIGHT, 1, CHANNELER, 9
	object_event 15,  7, SPRITE_CHANNELER, STAY, DOWN, 2, CHANNELER, 10
	object_event 14, 12, SPRITE_CHANNELER, STAY, LEFT, 3, CHANNELER, 12
