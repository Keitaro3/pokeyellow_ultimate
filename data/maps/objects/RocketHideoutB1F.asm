RocketHideoutB1F_Object:
	...
	def_object_events
	object_event 26,  8, SPRITE_ROCKET, STAY, LEFT, 1, ROCKET, 8
	object_event 12,  6, SPRITE_ROCKET, STAY, RIGHT, 2, ROCKET, 9
	object_event 18, 17, SPRITE_ROCKET, STAY, DOWN, 3, ROCKET, 10
	object_event 15, 25, SPRITE_ROCKET, STAY, RIGHT, 4, ROCKET, 11
	object_event 28, 18, SPRITE_ROCKET, STAY, LEFT, 5, ROCKET, 12
