SafariZoneWest_Object:
	...
	def_object_events
	object_event  8, 20, SPRITE_POKE_BALL, STAY, NONE, 0, 1, MAX_POTION
	object_event  9,  7, SPRITE_POKE_BALL, STAY, NONE, 0, 2, TM_DOUBLE_TEAM
	object_event 18, 18, SPRITE_POKE_BALL, STAY, NONE, 0, 3, MAX_REVIVE
	object_event 19,  7, SPRITE_POKE_BALL, STAY, NONE, 0, 4, GOLD_TEETH
