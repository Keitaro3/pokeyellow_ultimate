CeruleanCave1F_Object:
	...
	def_object_events
	object_event  7, 13, SPRITE_POKE_BALL, STAY, NONE, 0, 1, FULL_RESTORE
	object_event 19,  3, SPRITE_POKE_BALL, STAY, NONE, 0, 2, MAX_ELIXER
	object_event  5,  0, SPRITE_POKE_BALL, STAY, NONE, 0, 3, NUGGET
