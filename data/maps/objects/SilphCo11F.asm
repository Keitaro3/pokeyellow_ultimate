SilphCo11F_Object:
	...
	object_event  6,  9, SPRITE_GIOVANNI, STAY, DOWN, 3, GIOVANNI, 2
	object_event  3, 16, SPRITE_ROCKET, STAY, UP, 4, ROCKET, 41
	object_event 15,  9, SPRITE_ROCKET, STAY, UP, 5, ROCKET, 40
