MtMoon1F_Object:
	...
	def_object_events
	object_event  5,  6, SPRITE_HIKER, STAY, DOWN, 1, HIKER, 1
	object_event 12, 16, SPRITE_YOUNGSTER, STAY, RIGHT, 2, YOUNGSTER, 3
	object_event 30,  4, SPRITE_COOLTRAINER_F, STAY, DOWN, 3, LASS, 5
	object_event 24, 31, SPRITE_SUPER_NERD, STAY, UP, 4, SUPER_NERD, 1
	object_event 16, 23, SPRITE_COOLTRAINER_F, STAY, DOWN, 5, LASS, 6
	object_event  7, 22, SPRITE_YOUNGSTER, STAY, DOWN, 6, BUG_CATCHER, 7
	object_event 30, 27, SPRITE_YOUNGSTER, STAY, RIGHT, 7, BUG_CATCHER, 8
