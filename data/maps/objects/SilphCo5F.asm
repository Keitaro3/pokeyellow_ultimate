SilphCo5F_Object:
	...
	object_event  8, 16, SPRITE_ROCKET, STAY, RIGHT, 2, ROCKET, 28
	object_event  8,  3, SPRITE_SCIENTIST, STAY, RIGHT, 3, SCIENTIST, 6
	object_event 18, 10, SPRITE_ROCKER, STAY, UP, 4, JUGGLER, 1
	object_event 28,  4, SPRITE_ROCKET, STAY, UP, 5, ROCKET, 29
