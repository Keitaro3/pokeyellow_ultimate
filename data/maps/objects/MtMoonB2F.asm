MtMoonB2F_Object:
	...
	def_object_events
	object_event 12,  8, SPRITE_SUPER_NERD, STAY, RIGHT, 1, SUPER_NERD, 2
	object_event 11, 16, SPRITE_ROCKET, STAY, DOWN, 2, ROCKET, 1
	object_event 15, 22, SPRITE_ROCKET, STAY, DOWN, 3, ROCKET, 2
	object_event 29, 11, SPRITE_ROCKET, STAY, UP, 4, ROCKET, 3
	object_event 29, 17, SPRITE_ROCKET, STAY, LEFT, 5, ROCKET, 4
