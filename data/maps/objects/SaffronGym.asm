SaffronGym_Object:
	...
	def_object_events
	object_event  9,  8, SPRITE_COOLTRAINER_F, STAY, DOWN, 1, SABRINA, 1
	object_event 10,  1, SPRITE_CHANNELER, STAY, DOWN, 2, CHANNELER, 22
	object_event 17,  1, SPRITE_YOUNGSTER, STAY, DOWN, 3, PSYCHIC_TR, 1
	object_event  3,  7, SPRITE_CHANNELER, STAY, DOWN, 4, CHANNELER, 23
	object_event 17,  7, SPRITE_YOUNGSTER, STAY, DOWN, 5, PSYCHIC_TR, 2
	object_event  3, 13, SPRITE_CHANNELER, STAY, DOWN, 6, CHANNELER, 24
	object_event 17, 13, SPRITE_YOUNGSTER, STAY, DOWN, 7, PSYCHIC_TR, 3
	object_event  3,  1, SPRITE_YOUNGSTER, STAY, DOWN, 8, PSYCHIC_TR, 4
