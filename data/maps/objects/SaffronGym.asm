SaffronGym_Object:
	...
	def_object_events
	object_event  9,  8, SPRITE_SABRINA, STAY, DOWN, PAL_NPC_RED, 1, SABRINA, 1
	object_event 10,  1, SPRITE_CHANNELER, STAY, DOWN, PAL_NPC_BROWN, 2, CHANNELER, 22
	object_event 17,  1, SPRITE_BUG_CATCHER, STAY, DOWN, PAL_NPC_BLUE, 3, PSYCHIC_TR, 1
	object_event  3,  7, SPRITE_CHANNELER, STAY, DOWN, PAL_NPC_BROWN, 4, CHANNELER, 23
	object_event 17,  7, SPRITE_BUG_CATCHER, STAY, DOWN, PAL_NPC_BLUE, 5, PSYCHIC_TR, 2
	object_event  3, 13, SPRITE_CHANNELER, STAY, DOWN, PAL_NPC_BROWN, 6, CHANNELER, 24
	object_event 17, 13, SPRITE_BUG_CATCHER, STAY, DOWN, PAL_NPC_BLUE, 7, PSYCHIC_TR, 3
	object_event  3,  1, SPRITE_BUG_CATCHER, STAY, DOWN, PAL_NPC_BLUE, 8, PSYCHIC_TR, 4
	object_event 10, 15, SPRITE_GYM_GUIDE, STAY, DOWN, PAL_NPC_BLUE, 9 ; person
