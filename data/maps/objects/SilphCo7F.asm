SilphCo7F_Object:
	...
	object_event 10,  8, SPRITE_OFFICE_LADY, STAY, NONE, 4 ; person
	object_event 13,  1, SPRITE_ROCKET, STAY, DOWN, 5, ROCKET, 32
	object_event  2, 13, SPRITE_SCIENTIST, STAY, DOWN, 6, SCIENTIST, 8
	object_event 20,  2, SPRITE_ROCKET, STAY, LEFT, 7, ROCKET, 33
	object_event 19, 14, SPRITE_ROCKET, STAY, RIGHT, 8, ROCKET, 34
