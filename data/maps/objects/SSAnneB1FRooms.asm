SSAnneB1FRooms_Object:
	...
	def_object_events
	object_event  0, 13, SPRITE_SAILOR, STAY, DOWN, 1, SAILOR, 3
	object_event  2, 11, SPRITE_SAILOR, STAY, DOWN, 2, SAILOR, 4
	object_event 12,  3, SPRITE_SAILOR, STAY, LEFT, 3, SAILOR, 5
	object_event 22,  2, SPRITE_SAILOR, STAY, DOWN, 4, SAILOR, 6
	object_event  0,  2, SPRITE_SAILOR, STAY, RIGHT, 5, SAILOR, 7
	object_event  0,  4, SPRITE_FISHER, STAY, RIGHT, 6, FISHER, 2
