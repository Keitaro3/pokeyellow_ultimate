PokemonMansion1F_Object:
	...
	def_object_events
	object_event 17, 17, SPRITE_SCIENTIST, STAY, LEFT, PAL_NPC_BLUE, 1, SCIENTIST, 4
	object_event 14,  3, SPRITE_POKE_BALL, STAY, NONE, 0, 2, ESCAPE_ROPE
	object_event 18, 21, SPRITE_POKE_BALL, STAY, NONE, 0, 3, CARBOS
