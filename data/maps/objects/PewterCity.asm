PewterCity_Object:
	...
	def_object_events
	object_event  8, 15, SPRITE_COOLTRAINER_F, STAY, NONE, PAL_NPC_GREEN, 1 ; person
	object_event 17, 25, SPRITE_COOLTRAINER_M, STAY, NONE, 0, 2 ; person
	object_event 27, 17, SPRITE_SUPER_NERD, STAY, NONE, PAL_NPC_RED, 3 ; person
	object_event 26, 25, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, PAL_NPC_GREEN, 4 ; person
	object_event 35, 16, SPRITE_BUG_CATCHER, STAY, DOWN, PAL_NPC_BLUE, 5 ; person
