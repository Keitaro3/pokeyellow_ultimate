VictoryRoad2F_Object:
	...
	def_object_events
	object_event 12,  9, SPRITE_HIKER, STAY, LEFT, 1, BLACKBELT, 9
	object_event 21, 13, SPRITE_SUPER_NERD, STAY, LEFT, 2, JUGGLER, 2
	object_event 19,  8, SPRITE_COOLTRAINER_M, STAY, DOWN, 3, TAMER, 5
	object_event  4,  2, SPRITE_SUPER_NERD, STAY, DOWN, 4, POKEMANIAC, 6
	object_event 26,  3, SPRITE_SUPER_NERD, STAY, LEFT, 5, JUGGLER, 5
	object_event 11,  5, SPRITE_BIRD, STAY, UP, 6, MOLTRES, 50 | PKMN
