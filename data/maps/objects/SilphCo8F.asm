SilphCo8F_Object:
	...
	object_event 19,  2, SPRITE_ROCKET, STAY, LEFT, 2, ROCKET, 35
	object_event 10,  2, SPRITE_SCIENTIST, STAY, DOWN, 3, SCIENTIST, 9
	object_event 12, 15, SPRITE_ROCKET, STAY, RIGHT, 4, ROCKET, 36
