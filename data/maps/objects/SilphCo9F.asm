SilphCo9F_Object:
	...
	object_event  2,  4, SPRITE_ROCKET, STAY, UP, 2, ROCKET, 37
	object_event 21, 13, SPRITE_SCIENTIST, STAY, DOWN, 3, SCIENTIST, 10
	object_event 13, 16, SPRITE_ROCKET, STAY, UP, 4, ROCKET, 38
