Route18_Object:
	...
	def_object_events
	object_event 36, 11, SPRITE_COOLTRAINER_M, STAY, RIGHT, 1, BIRD_KEEPER, 8
	object_event 40, 15, SPRITE_COOLTRAINER_M, STAY, LEFT, 2, BIRD_KEEPER, 9
	object_event 42, 13, SPRITE_COOLTRAINER_M, STAY, LEFT, 3, BIRD_KEEPER, 10
