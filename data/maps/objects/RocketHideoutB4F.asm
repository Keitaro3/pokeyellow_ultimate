RocketHideoutB4F_Object:
	...
	def_object_events
	object_event 25,  3, SPRITE_GIOVANNI, STAY, DOWN, 1, GIOVANNI, 1
	object_event 23, 12, SPRITE_ROCKET, STAY, DOWN, 2, ROCKET, 16
	object_event 26, 12, SPRITE_ROCKET, STAY, DOWN, 3, ROCKET, 17
	object_event 11,  2, SPRITE_ROCKET, STAY, DOWN, 4, ROCKET, 18
