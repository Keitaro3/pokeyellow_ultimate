PokemonTower6F_Object:
	...
	def_object_events
	object_event 12, 10, SPRITE_CHANNELER, STAY, RIGHT, 1, CHANNELER, 19
	object_event  9,  5, SPRITE_CHANNELER, STAY, DOWN, 2, CHANNELER, 20
	object_event 16,  5, SPRITE_CHANNELER, STAY, LEFT, 3, CHANNELER, 21
