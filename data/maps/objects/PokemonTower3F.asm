PokemonTower3F_Object:
	...
	def_object_events
	object_event 12,  3, SPRITE_CHANNELER, STAY, LEFT, 1, CHANNELER, 5
	object_event  9,  8, SPRITE_CHANNELER, STAY, DOWN, 2, CHANNELER, 6
	object_event 10, 13, SPRITE_CHANNELER, STAY, DOWN, 3, CHANNELER, 8
