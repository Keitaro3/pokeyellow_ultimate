LavenderTown_Object:
	...
	def_object_events
	object_event 15,  9, SPRITE_LITTLE_GIRL, WALK, ANY_DIR, PAL_NPC_BLUE, 1 ; person
	object_event  9, 10, SPRITE_COOLTRAINER_M, STAY, NONE, 0, 2 ; person
	object_event  8,  7, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, PAL_NPC_RED, 3 ; person
