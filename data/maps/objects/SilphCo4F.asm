SilphCo4F_Object:
	...
	object_event  9, 14, SPRITE_ROCKET, STAY, RIGHT, 2, ROCKET, 26
	object_event 14,  6, SPRITE_SCIENTIST, STAY, LEFT, 3, SCIENTIST, 5
	object_event 26, 10, SPRITE_ROCKET, STAY, UP, 4, ROCKET, 27
