SSAnne1FRooms_Object:
	...
	def_object_events
	object_event  2,  3, SPRITE_GENTLEMAN, STAY, LEFT, 1, GENTLEMAN, 1
	object_event 11,  4, SPRITE_GENTLEMAN, STAY, UP, 2, GENTLEMAN, 2
	object_event 11, 14, SPRITE_YOUNGSTER, STAY, UP, 3, YOUNGSTER, 8
	object_event 13, 11, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, LASS, 11
