VermilionCity_Object:
	...
	def_object_events
	object_event 19,  7, SPRITE_TEACHER, WALK, LEFT_RIGHT, PAL_NPC_RED, 1 ; person
	object_event 14,  6, SPRITE_GAMBLER, STAY, NONE, PAL_NPC_BLUE, 2 ; person
	object_event 19, 30, SPRITE_SAILOR, STAY, UP, 0, 3 ; person
	object_event 30,  7, SPRITE_GAMBLER, STAY, NONE, 0, 4 ; person
	object_event 29,  9, SPRITE_MONSTER, WALK, UP_DOWN, PAL_NPC_BLUE, 5 ; person
	object_event 25, 27, SPRITE_SAILOR, WALK, LEFT_RIGHT, 0, 6 ; person
