ViridianForest_Object:
	...
	object_event 30, 33, SPRITE_YOUNGSTER, STAY, LEFT, 2, BUG_CATCHER, 1
	object_event 30, 19, SPRITE_YOUNGSTER, STAY, LEFT, 3, BUG_CATCHER, 2
	object_event  2, 18, SPRITE_YOUNGSTER, STAY, LEFT, 4, BUG_CATCHER, 3
	object_event  2, 41, SPRITE_COOLTRAINER_F, STAY, NONE, 5, LASS, 19
	object_event 13, 17, SPRITE_YOUNGSTER, STAY, RIGHT, 6, BUG_CATCHER, 15
