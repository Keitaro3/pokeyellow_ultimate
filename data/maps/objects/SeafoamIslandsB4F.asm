SeafoamIslandsB4F_Object:
	...
	def_object_events
	object_event  4, 15, SPRITE_BOULDER, STAY, NONE, 0, 1 ; person
	object_event  5, 15, SPRITE_BOULDER, STAY, NONE, 0, 2 ; person
	object_event  6,  1, SPRITE_BIRD, STAY, DOWN, PAL_NPC_BLUE, 3, ARTICUNO, 50 | PKMN
